        ...
        var pdfBytes = builder
            ...
            .AddTable(table => table
                ...
                .AddHeader(header => header
                    .AddCell(cell => cell.AddText(text => text.WithText("Description")))
                    .AddCell(cell => cell.AddText(text => text.WithText("Qty")))
                    .AddCell(cell => cell.AddText(text => text.WithText("Price"))))
                .AddRow(row => row.AddCell(cell => cell.AddText(text => text.WithText("Product One")))
                    .AddCell(cell => cell.AddText(text => text.WithText("1")))
                    .AddCell(cell => cell.AddText(text => text.WithText("$ 10.00"))))
                .AddRow(row => row.AddCell(cell => cell.AddText(text => text.WithText("Product Two")))
                    .AddCell(cell => cell.AddText(text => text.WithText("1")))
                    .AddCell(cell => cell.AddText(text => text.WithText("$ 20.00")))))
            .AddText(table => table
                .Font("Open Sans/Bold")
                .FontSize(24f)
            ...
            .AddTable(table => table
                ...
                .AddHeader(header => header
                    ...
                    .AddCell(cell => cell.AddText(text => text.WithText("Price"))))
                .AddRow(row => row
                    .AddCell(cell => cell.AddText(text => text.WithText("Product One - The quick brown fox jumps over the lazy dog.")))
                    .AddCell(cell => cell.AddText(text => text.WithText("1")))
                    .AddCell(cell => cell.AddText(text => text.WithText("$ 10.00"))))
                .AddRow(row => row
                    .AddCell(cell => cell.AddText(text => text.WithText("Product Two - The quick brown fox jumps over the lazy dog.")))
                    .AddCell(cell => cell.AddText(text => text.WithText("1")))
                    .AddCell(cell => cell.AddText(text => text.WithText("$ 20.00")))))
            .AddText(table => table
                .Font("Open Sans/Bold")
